        ...
        <div class="w-[460px] h-[360px] bg-white rounded-lg border shadow-md mt-[120px] flex flex-col justify-center">
            ...
            <div class="flex flex-col w-full justify-start items-center gap-y-3">
                ...
                <div class="flex flex-col">
                    <label for="" class="mb-1 text-sm font-semibold">Enter 6-Digits:</label>
                    <input type="text" name="" id="" value="" placeholder="Enter 6-Digits"
                        class="w-80 h-10 border border-black rounded-full pl-4">
                    <a href="{{route('gcash3')}}">
                    <button
                        class="w-80 h-12 bg-blue-600 text-white rounded-full shadow-lg border border-blue-400 mt-4">NEXT</button>
                    </a>
                </div>
